...
return [
    ...
    */
    ...
    'password' => [
            ...
            'uncompromised' => 'El valor del campo :attribute está comprometido. Elige un valor diferente, por favor.',
        ],
    ...
    */
    ...
    'custom' => [
        ...
        'email' => [
            'required' => '¡El campo :attribute es obligatorio, joputa!',
        ],

        'telefono' => [
            'numeric' => '¡Idiota! El campo :attribute tiene que ser de tipo numérico, ¡que es un teléfono! ¡No te enteras!',
            'between' => '¿Es que no sabes cómo es un teléfono, mamón!'
        ],
    ],
